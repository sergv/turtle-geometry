...
(defn turtle-geometry-accept-file? [^String name]
...
(defproject turtle-geometry/turtle-geometry "1.0.0"
  :description "Intepreter for dialect of LOGO programs. Intended for use
with Turtle Geometry book."
  :url "https://github.com/sergv/turtle-geometry"
  ...
  :dependencies [[android/clojure "1.5.0"]
                 ...
                 [android-utils/android-utils "0.7.0"]
  ...
  :android ~(merge
             {:gen-path "bin"
              ...
              :accept-file-func turtle-geometry-accept-file?

              :proguard-opts ["-ignorewarnings"]
              :proguard-conf-path "proguard.cfg"

              :external-classes-paths ["lib/android-support-v4.jar"
                                       "lib/jscheme.jar"]
